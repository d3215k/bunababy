        ...
        <div>
            ...
            ">
                ...
                @foreach ($titles as $item)
                    <div
                        class="row-start-1 col-start-{{ $loop->iteration + 1 }} sticky top-0 z-10 bg-white border-slate-100 bg-clip-padding text-slate-900 border-b text-xs font-medium text-center h-10 w-[170px] min-w-[170px] max-w-[170px] flex items-center justify-center overflow-hidden">
