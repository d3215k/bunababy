        ...
        <div>
            ...
            ">
                ...
                @foreach ($titles as $item)
                    <div
                        class="row-start-1 col-start-{{ $loop->iteration + 1 }} sticky top-0 z-10 bg-white border-slate-100 bg-clip-padding text-slate-900 border-b text-sm font-medium text-center w-[210px] min-w-[210px] max-w-[210px] flex items-center justify-center">
                        {{ $item['name'] }}
                    </div>
                @endforeach
